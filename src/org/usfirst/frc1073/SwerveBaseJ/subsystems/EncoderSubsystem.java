...
public class EncoderSubsystem extends Subsystem implements PIDSubsystem {
    ...
    DigitalInput frontLeftDir = RobotMap.encoderSubsystemfrontLeftDir;
    DigitalInput frontRightDir = RobotMap.encoderSubsystemfrontRightDir;
    DigitalInput rearLeftDir = RobotMap.encoderSubsystemrearLeftDir;
    DigitalInput rearRightDir = RobotMap.encoderSubsystemrearRightDir;
