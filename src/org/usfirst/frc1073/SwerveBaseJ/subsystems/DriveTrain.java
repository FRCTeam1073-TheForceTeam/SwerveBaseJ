...
public class DriveTrain extends Subsystem implements PIDSubsystem {
    ...
    SpeedController frontRightSpeedMotor = RobotMap.driveTrainfrontRightSpeedMotor;
    ...
    public void setFrontLeftSpeed(double speed){
    	frontLeftSpeedMotor.set(speed);
    }
    public void setRearLeftSpeed(double speed){
    	rearLeftSpeedMotor.set(speed);
    }
    public void setRearRightSpeed(double speed){
    	rearRightSpeedMotor.set(speed);
    }
